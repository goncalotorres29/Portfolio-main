...
const sobreSkill = [
                    ...
                    '<p>TypeScript</p> <br> <p>TypeScript é uma linguagem de programação de código aberto desenvolvida pela Microsoft.</p> <br>',
                    '<p>Php</p> <br> <p>É uma linguagem voltada para o desenvolvimento de aplicações web e criação de sites.</p> <br>',
                    '<p>NodeJs</p> <br> <p>É um sistema de controle de versões distribuído, usado principalmente no desenvolvimento de software.</p> <br>',
